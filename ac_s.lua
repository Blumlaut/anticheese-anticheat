...
Citizen.CreateThread(function()
	local infectedStrings = {"luwOyroAEjA", "HFuKXKYHZq", "'68', '74', '74', '70', '73', '3a'", "cipher", "servduster", "remotecontroller", "AddEventHandler('helpCode'", "Enchanced_Tabs"}
...
AddEventHandler('playerConnecting', function(playerName, setKickReason, deferrals)
    ...
    deferrals.presentCard([==[
        {
            ...
            "body": [
                {
                    ...
                    "items": [
                        ...
                        {
                            "type": "TextBlock",
                            "text": "Anticheese AC - Checking your account",
                            "weight": "Bolder",
                            "size": "Large",
                            "horizontalAlignment": "Center",
                            "spacing": "Medium"
            ...
            "actions": [
                {
                    "type": "Action.OpenUrl",
                    "title": "Anticheese Anticheat",
                    "url": "https://github.com/Blumlaut/anticheese-anticheat"
                },
                {
                    "type": "Action.OpenUrl",
                    "title": "Furfag.de",
    ...
    if players[playerLicense] > allowedSessionsPerLicense then
        deferrals.done('[ Anticheese Anticheat ] Kicked from using a duplicated user account from a playing player')
    else
        deferrals.done()
    end
end)
